# Docker image for couchdb using the debian template
ARG IMAGE_NAME="couchdb"
ARG PHP_SERVER="couchdb"
ARG BUILD_DATE="Wed Aug 23 02:51:40 AM EDT 2023"
ARG LANGUAGE="en_US.UTF-8"
ARG TIMEZONE="America/New_York"
ARG WWW_ROOT_DIR="/usr/share/webapps/couchdb"
ARG DEFAULT_FILE_DIR="/usr/local/share/template-files"
ARG DEFAULT_DATA_DIR="/usr/local/share/template-files/data"
ARG DEFAULT_CONF_DIR="/usr/local/share/template-files/config"
ARG DEFAULT_TEMPLATE_DIR="/usr/local/share/template-files/defaults"

ARG IMAGE_REPO="couchdb"
ARG IMAGE_VERSION="latest"
ARG CONTAINER_VERSION="${IMAGE_VERSION}"

ARG SERVICE_PORT="80"
ARG EXPOSE_PORTS="80 4369 5984 9100 17986"
ARG PHP_VERSION=""
ARG NODE_VERSION=""
ARG NODE_MANAGER=""
...
ENV HOSTNAME="casjaysdev-couchdb"
...
RUN set -ex; \
  ...
  chown -Rf couchdb:couchdb /opt/couchdb;chown -Rf www-data:www-data /etc/nginx; \
  echo ""
...
LABEL org.opencontainers.image.url="https://hub.docker.com/r/casjaysdevdocker/couchdb"
LABEL org.opencontainers.image.url.source="https://hub.docker.com/r/casjaysdevdocker/couchdb"
LABEL org.opencontainers.image.vcs-type="Git"
LABEL org.opencontainers.image.vcs-ref="${BUILD_VERSION}"
LABEL org.opencontainers.image.vcs-url="https://hub.docker.com/r/casjaysdevdocker/couchdb"
LABEL org.opencontainers.image.documentation="https://hub.docker.com/r/casjaysdevdocker/couchdb"
