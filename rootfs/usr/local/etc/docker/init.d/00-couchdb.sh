...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202308230219-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  WTFPL
# @@ReadME           :  00-couchdb.sh --help
# @@Copyright        :  Copyright: (c) 2023 Jason Hempstead, Casjays Developments
# @@Created          :  Wednesday, Aug 23, 2023 02:19 EDT
# @@File             :  00-couchdb.sh
# @@Description      :
...
__update_conf_files() {
  ...
  # replace variables
  __replace "REPLACE_ROOT_PASS" "$root_user_pass" "$CONF_DIR/default.ini"
  __replace "REPLACE_ROOT_ADMIN" "$root_user_name" "$CONF_DIR/default.ini"
  __replace "REPLACE_ROOT_PASS" "$root_user_pass" "$ETC_DIR/default.ini"
  __replace "REPLACE_ROOT_ADMIN" "$root_user_name" "$ETC_DIR/default.ini"
